...
class Application:
    ...
    def conectarBanco(self):
        ...
        self.cursor.execute('''CREATE TABLE IF NOT EXISTS tb_usuario(id_usuario INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
    ...
    def inserirUsuario(self):
        ...
        self.cursor.execute("INSERT INTO tb_usuario(nm_usuario, telefone, email, usuario, senha) VALUES(%s, %s, %s, %s, %s)",
    ...
    def alterarUsuario(self):
        ...
        (nome,telefone,email,usuario,senha,id_usuario))
    ...
    def excluirUsuario(self):
        ...
        self.conn.commit()
        self.lblmsg["text"] = "Usuário excluido com sucesso"
        self.limparCampos()
